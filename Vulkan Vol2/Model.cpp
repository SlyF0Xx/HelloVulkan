																														...
																														VertBuf(device), IndexBuf(device)
{
	...
	VertexInputInfo.pVertexBindingDescriptions = &VertexInputDesc;
	...
	LayoutInfo.flags = 0;
	LayoutInfo.setLayoutCount = Descriptors.size();
	LayoutInfo.pSetLayouts = Descriptors.data();
	...
	*/
	...
	RasterizationInfo.rasterizerDiscardEnable = VK_TRUE; //VK_FALSE
